...
use evaluation::routes::evaluation_routes::protected_evaluations_routes;
use notifications::routes::notification_routes::protected_notifications_routes;
use std::env;
        ...
        App::new()
            ...
            .service(
                web::scope("/api")
                    ...
                    .configure(protected_evaluations_routes)
                    .configure(protected_notifications_routes)
            )
    })
